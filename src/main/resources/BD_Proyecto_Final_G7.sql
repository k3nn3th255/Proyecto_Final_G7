...
drop schema if exists Fide_Autos;
drop user if exists usuario_prueba;
CREATE SCHEMA Fide_Autos ;
...
create table Fide_Autos.categoria (
...
insert into Fide_Autos.categoria(id_categoria, descripcion, activo)
values(1, 'SUV', true),
(2, 'Sedán', true),
(3, 'Pick-Up', true),
(4, 'Deportivo', true);

create table Fide_Autos.producto (
...
insert into Fide_Autos.producto(id_producto, id_categoria, marca, modelo, año, combustible, transmision,
...
CREATE TABLE Fide_Autos.usuario (
...
create table Fide_Autos.factura (
...
INSERT INTO Fide_Autos.usuario (id_usuario, username,password,nombre, apellidos, correo, telefono,ruta_imagen,activo) VALUES 
...
insert into Fide_Autos.rol (id_rol, nombre, id_usuario) values
